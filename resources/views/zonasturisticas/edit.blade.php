...
<div class="jumbotron">
<form method="post" action="{{ route('zonasturisticas.update', $zonaTuristica->$id) }} ">
    @csrf
    @method('PUT')
...
<input type="hidden" name="id" value="{{ $zonaTuristica->id }}">
    ...
    <div>
        ...
        <textarea class="form-control" name="Descripcion" id="" cols="30" rows="5"> {{ $zonaTuristica->Descripcion }}</textarea>   
    </div>
    <br>
    <div>
